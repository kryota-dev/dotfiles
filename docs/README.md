...
| [Account isolation: aliases, env & tmux sockets](agents/account-isolation.md) | Per-account env var table, full alias matrix, `_claude_with_home`, and the dmux socket gotcha |
