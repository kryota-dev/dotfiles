...
- The Fable 5 orchestrator system prompt (`home/dot_claude/fable-orchestrator-prompt.md`) — appended to Fable 5 sessions launched via `cldf` / `cldf-r06` / `hcldf` / `hcldf-r06`, so it must steer Japanese-speaking session output
