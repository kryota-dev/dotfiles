...
#
# Account selection (~/.codex vs ~/.codex-r06) and `--profile main` injection now live in the
...
# interactive, hook, Claude's Bash tool — so bare `codex` now loads main.config.toml too, and the
